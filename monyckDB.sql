...
--
-- Hôte : localhost
-- Généré le :  mar. 21 nov. 2017 à 12:54
...
(1, 'Ticket', 'Ceci est la description du ticket de test...', '2017-11-21', '00:20:17', 2, 3);
...
(2, 'Admin', 'SUPREME', 'admin@admin.com', 'ADMIN', '123456', '0000-00-00');
...
--
ALTER TABLE `tickets`
  ADD CONSTRAINT `id_skill` FOREIGN KEY (`id_skill`) REFERENCES `skills` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `id_user_ticket` FOREIGN KEY (`id_user_ticket`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
